	...
	<div class="reg_img">
		...
		<?php
			...
			if($count=0)
				...
				mysqli_query($db,"INSERT INTO `student` VALUES('$_POST[first]', '$_POST[last]', '$_POST[id]', '$_POST[year]', '$_POST[section]', '$_POST[username]', '$_POST[password]', '$_POST[email]', ' $_POST[contact]');");
  		 ?>
